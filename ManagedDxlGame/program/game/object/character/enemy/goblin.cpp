...
// アップデート
// =====================================================================================
void Goblin::update(float delta_time) {
...
// 描画
// =====================================================================================
void Goblin::draw(const std::shared_ptr<Camera> camera) {
...
// 描画
// =====================================================================================
void Goblin::drawEffect(const std::shared_ptr<Camera> camera) {
...
// クローンを生成する
// =====================================================================================
std::shared_ptr<EnemyBase> Goblin::createClone() const {

	std::shared_ptr<Goblin> clone = std::make_shared<Goblin>();
	return clone;
}
...
// 敵の強さを設定する
// =====================================================================================
void Goblin::setEnemyLevel(int lv) {
...
// =====================================================================================
void Goblin::moveToTargetPos(const tnl::Vector3& target_pos) {
...
void Goblin::startAttack() {
	...
	sequence_.change(&Goblin::seqAttack);
}

// =====================================================================================
// 行動を開始する
// =====================================================================================
void Goblin::beginAction() {

	if (!sequence_.isComparable(&Goblin::seqIdle)) {
		tnl::DebugTrace("sequence_ がIdleになっていません\n");
		return;
	}
	if (act_state_ == eActState::MOVE) {
		sequence_.immediatelyChange(&Goblin::seqMove);
		return;
	}
}
...
void Goblin::takeDamage(int damage) {
	...
	sequence_.change(&Goblin::seqTakeDamage);
}
...
// 待機シーケンス
// =====================================================================================
bool Goblin::seqIdle(const float delta_time) {
...
// next_pos_ に移動させる。
// =====================================================================================
bool Goblin::seqMove(const float delta_time) {
	...
	if (action_count_ < 1) {
		++action_count_;
		sequence_.change(&Goblin::seqIdle);
		decideAction();
...
// 攻撃シーケンス
// ====================================================
bool Goblin::seqAttack(const float delta_time) {
...
bool Goblin::seqTakeDamage(const float delta_time) {
...
void Goblin::startAction() {

	switch (act_state_)
	{
	case eActState::MOVE:
		sequence_.change(&Goblin::seqMove);
		break;
		sequence_.change(&Goblin::seqAttack);
...
// =====================================================================================
void Goblin::setNextPosToTarget() {
...
// 各セルの移動コストから次の位置を決める
// =====================================================================================
void Goblin::decideNextPosFromCellCost() {
...
// 指定した方向のセルが行動できるか判定
// =====================================================================================
bool Goblin::canActionToCell(const tnl::Vector2i& pos) {
...
// 指定した方向が攻撃可能か
// =====================================================================================
bool Goblin::canAttackInDir(eDir_8 dir) {
